...
@AutenticadoRequired
@Api(tags = {"aluno-duvida"}, produces = MediaType.APPLICATION_JSON_VALUE, description = "Operações com as dúvidas de um aluno")
public class AlunoDuvidaController {
	...
	public ResponseEntity<DuvidaResponseDTO> postDuvida(@ApiParam(required = true, name = "id", value = "O ID do aluno � quem a duvida pertence") @PathVariable Integer id,
